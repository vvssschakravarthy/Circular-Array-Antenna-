...
fileName='msgoa_8_a.mat';
if (exist('msgoa_8_a.mat'))
    delete 'msgoa_8_a.mat';
end
...
dim=Ndvals; 
pn=30; % Number of individuals
gn=2000; %Number of iterations
tnum=10;
for tr=1:tnum
    % Call the MSGOA msgofunction(pn,dim,gn,lb,ub,func_no)
 
    [gbest,fmin, SLL, BW]= msgofunction(pn,dim,gn,Lb,Ub)
